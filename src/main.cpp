...
#include "../encoding/sounddata.h"

SampleHuffman huffmann(creature_SOUNDDATA, creature_HUFFMAN, creature_SOUNDDATA_BITS);

void setup()
{
  huffmann.setLoopingOn();
  startMozzi();
}
